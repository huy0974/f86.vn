<div id="page-body" class="d-flex">
    <div id="sidebar" class="bg-white">
        <ul id="sidebar-menu">
            ...
            <li class="nav-link">
                <a href="?mod=slider&action=list_slider">
                    <div class="nav-link-icon d-inline-flex">
                        <i class="far fa-folder"></i>
                    </div>
                    Slider
                ...
                <ul class="sub-menu">
                    <li><a href="?mod=slider&action=add_slider">Thêm mới</a></li>
                    <li><a href="?mod=slider&action=list_slider">Danh sách slider</a></li>
                </ul>
            </li>
            <li class="nav-link">
            ...
            <li class="nav-link">
                ...
                <ul class="sub-menu">
                    <li><a href="?mod=video&action=add_img_home">Thay đổi video</a></li>
