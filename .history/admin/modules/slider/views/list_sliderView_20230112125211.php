                ...
                <tbody class="text-center">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button id="btn_del_slider" class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Delete" data-id="<?php echo $value['id'] ?>"><i class="fa fa-trash"></i></button>
                            </td>
