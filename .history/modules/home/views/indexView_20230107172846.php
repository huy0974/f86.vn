            ...
            <div class="row">
                <div class="form-intro col-md-7">
                    ...
                    <div class="wrapper-button">
                        <a href="?mod=page&controller=index&action=reg">
                            <button class="btn-detail">Vay ngay</button>
                        </a>
                    </div>
                </div>
                <!-- END FORM-INTRO  -->
                <div class="wrapper-img-option col-md-5">
            ...
            <div class="row">
                <div class="content-left col-xl-7">
                    <a href="" class="content-blog">
                        ...
                        <div class="info">
                            <h3>Dự toán bội chi ngân sách Nhà nước hơn 455.000 tỷ đồng trong năm nay</h3>
                            <span class="date-created">23-12-2022</span>
                            <p>Theo dự toán, tổng thu ngân sách Nhà nước năm nay là 1,62 triệu tỷ đồng, chi ngân sách Nhà nước là 2,07 triệu tỷ đồng. </p>
                        </div>
                    </a>
                </div>
                <div class="content-right col-xl-5 d-lg-flex flex-lg-column flex-row justify-content-lg-between">
                    <a href="" class="content-blog-extra d-flex mb-5">
                        <div class="row no-gutters">
                            <div class="info col-md-7">
                                <h3>Vay vốn ngân hàng nào lãi suất thấp nhất?</h3>
                                <span class="date-created">22-04-2022</span>
                                <p>Dịch vụ hỗ trợ vay vốn ngân hàng trở nên quen thuộc và thiết thực đối với mọi gia đình, doanh nghiệp Việt Nam.</p>
                            </div>
                            <div class="block-image col-md-5"> <img src="./public/images/home/featured-news/20220422110229944-vay-von-ngan-hang-nao-lai-suat-thap-nhat-1.jpg"> </div>
                        </div>
                    </a>
                    <a href="" class="content-blog-extra d-flex mb-5">
                        <div class="row no-gutters">
                            <div class="info col-md-7">
                                <h3>Làm hồ sơ vay vốn ngân hàng gồm những gì?</h3>
                                <span class="date-created">22-04-2022</span>
                                <p>Vay vốn ngân hàng dần giúp nhiều người vượt qua được những bế tắc về tài chính. Tìm hiểu ngay về thủ tục hồ sơ va...</p>
                            </div>
                            <div class="block-image col-md-5"> <img src="./public/images/home/featured-news/20220422110229944-vay-von-ngan-hang-nao-lai-suat-thap-nhat-1.jpg"> </div>
                        </div>
                    </a>
                    <a href="" class="content-blog-extra d-flex">
                        <div class="row no-gutters">
                            <div class="info col-md-7">
                                <h3>Cầm xe máy lãi suất thấp tại F88</h3>
                                <span class="date-created">22-04-2022</span>
                                <p>Cầm xe máy lãi suất thấp tại F88</p>
                            </div>
                            <div class="block-image col-md-5"> <img src="./public/images/home/featured-news/20220422110229944-vay-von-ngan-hang-nao-lai-suat-thap-nhat-1.jpg"> </div>
                        </div>
                    </a>
