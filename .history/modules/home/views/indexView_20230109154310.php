            ...
            <div class="row">
                <div class="form-intro col-md-7">
                    ...
                    <ul class="list-content-info">
                        <li class="item-option"><span class="icon"><i class="fa-regular fa-circle-check"></i></span>Chỉ cần Căn cước công dân hoặc Sổ hộ khẩu, duyệt vay nhanh chóng trong <span class="color-green">15 phút</span></li>
