...
<div class="container">
    <div class="wp-title">
        <h2 class="title-should-chose text-center text-uppercase">Bạn nên chọn 23K</h2>
        <h2 class="title-should text-center text-uppercase">Giải pháp tài chính tin cậy</h2>
    </div>
    <div id="should-choose" class="container box should-choose-home">
        <!-- <div class="head-box">
            <div class="row">
                <div class="col-md-12">
