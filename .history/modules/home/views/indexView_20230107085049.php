            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="content-right">
                        <div class="row flex-lg-column justify-content-lg-between align-content-lg-between">
                            <div class="col-lg-12">
                                <a href="" class="content-blog-extra d-lg-flex flex-lg-row">
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="info">
                            ...
                            <div class="col-lg-12">
                                <a href="" class="content-blog-extra">xin chào</a>
                            </div>
                            <div class="col-lg-12">
                                <a href="" class="content-blog-extra">xin chào</a>
                            </div>
