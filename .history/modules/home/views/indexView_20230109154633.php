            ...
            <div class="row">
                <div class="form-intro col-md-7">
                    ...
                    <ul class="list-content-info">
                        <li class="item-option"><span class="icon"><i class="fa-regular fa-circle-check"></i></span>Chỉ cần Căn cước công dân hoặc Sổ hộ khẩu, duyệt vay nhanh chóng trong <span class="d-inline-block color-green">15 phút</span></li>
                ...
                <div class="row text-center">
                    <div class="col-6 col-md-4 col-xl-2">
                        <li class="reason-item">
                            <a href="?mod=page&action=reg"><img src="./public/images/thu_tuc.png" alt=""></a>
                            <p>Thủ tục đơn giản chỉ cần CCCD & sổ hộ khẩu Hà Nội</p>
                        </li>
                    </div>
                    <div class="col-6 col-md-4 col-xl-2">
                        <li class="reason-item">
                            <a href="?mod=page&action=reg"><img src="./public/images/tham_dinh.png" alt=""></a>
                            <p>
                    ...
                    <div class="col-6 col-md-4 col-xl-2">
                        <li class="reason-item">
                            <a href="?mod=page&action=reg"><img src="./public/images//lai_suat.png" alt=""></a>
                            <p>Lãi suất ưu đãi nhất Hà Nội</p>
                        </li>
                    </div>
                    <div class="col-6 col-md-4 col-xl-2">
                        <li class="reason-item">
                            <a href="?mod=page&action=reg"><img src="./public/images/tu_van.png" alt=""></a>
                            <p>Đăng ký tư vấn online dễ dàng</p>
                        </li>
                    </div>
                    <div class="col-6 col-md-4 col-xl-2">
                        <li class="reason-item">
                            <a href="?mod=page&action=reg"><img src="./public/images/bao_mat.png" alt=""></a>
                            <p>Bảo mật thông tin khách hàng</p>
                        </li>
                    </div>
                    <div class="col-6 col-md-4 col-xl-2">
                        <li class="reason-item">
                            <a href="?mod=page&action=reg"><img src="./public/images/niemtin.png" alt=""></a>
