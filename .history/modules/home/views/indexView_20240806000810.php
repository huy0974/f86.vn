            ...
            <div class="row">
                <div class="form-intro col-md-7 order-1 order-md-0">
                    ...
                    <ul class="list-content-info">
                        <li class="item-option"><span class="icon"><i class="fa-regular fa-circle-check"></i></span>Chỉ
                            cần có tối thiểu CCCD Chip, duyệt vay nhanh chóng trong 15 phút</li>
                        <li class="item-option"><span class="icon"><i class="fa-regular fa-circle-check"></i></span>15
                            phút có tiền</li>
                        <li class="item-option"><span class="icon"><i
                                    class="fa-regular fa-circle-check"></i></span>Khoản vay tối đa 50 triệu, xét duyệt
                            nhanh chóng</li>
                        <li class="item-option"><span class="icon"><i class="fa-regular fa-circle-check"></i></span>Lãi
                            suất vay hợp lý</li>
                        <li class="item-option"><span class="icon"><i class="fa-regular fa-circle-check"></i></span>Hỗ
                            trợ vay Icloud Hà Nội</li>
                    </ul>
...
<div class="container">
    <div class="should-choose-home">
        <div class="wp-title">
            <h2 class="title-should-choose text-center text-uppercase">Bạn nên chọn F86</h2>
            ...
            <ul class="list-reason">
                <div class="row text-center">
                    ...
                    <div class="col-6 col-md-4 col-xl-2">
                        <li class="reason-item">
                            <a href="thong-tin-dang-ky.html#wp-info-reg"><img
                                    src="./public/images/should_choose/tu_van.png" alt=""></a>
            ...
            <div class="row">
                <div class="content-left col-12 col-xl-7">
                    <a href="thong-tin-dang-ky.html#wp-info-reg" class="content-blog">
                        <div>
                            <img src="./public/images/home/featured-news/20220425114147208-lam-phat-la-gi-nguyen-nhan-dan-den-lam-phat-2.jpg"
                                alt="">
                        </div>
                        <div class="info">
                            <h3>Lạm phát là gì? Các nguyên nhân dẫn đến lạm phát</h3>
                            <span class="date-created">01-01-2023</span>
                            <p>Lạm phát là gì? Nguyên nhân lạm phát là gì? Chúng ta hãy cùng tìm hiểu tất cả những vấn
                                đề phải biết xoay quanh lạm phát nhé!</p>
                        </div>
                    </a>
                </div>
                <div class="content-right col-12 col-xl-5 d-lg-flex flex-lg-column flex-row justify-content-lg-between">
                    <a href="thong-tin-dang-ky.html#wp-info-reg" class="content-blog-extra d-flex mb-5">
                        <div class="row no-gutters">
                            <div class="info col-md-7 order-1 order-lg-0">
                                ...
                                <p>Giới siêu giàu sẽ tiếp tục đổ về dự án bất động sản cao cấp với những sản
                                    phẩm sang trọng</p>
                            </div>
                            <div class="block-image col-md-5 order-0 order-lg-1"> <img
                                    src="./public/images/home/featured-news/anh-3-sunneva-island-diem-den-9851-6946-1672908629.jpg">
                            </div>
                        </div>
                    </a>
                    <a href="thong-tin-dang-ky.html#wp-info-reg" class="content-blog-extra d-flex mb-5">
                        <div class="row no-gutters">
                            <div class="info col-md-7 order-1 order-lg-0">
                                ...
                                <p>Chứng khoán tăng mạnh trong phiên đầu tiên của năm mới khi lực mua chiếm ưu thế áp
                                    đảo</p>
                            </div>
                            <div class="block-image col-md-5 order-0 order-lg-1"> <img
                                    src="./public/images/home/featured-news/QUYN8123-1672736186-4266-1672736217.jpg">
                            </div>
                        </div>
                    </a>
                    <a href="thong-tin-dang-ky.html#wp-info-reg" class="content-blog-extra d-flex">
                        <div class="row no-gutters">
                            ...
                            <div class="block-image col-md-5 order-0 order-lg-1"> <img
                                    src="./public/images/home/featured-news/mark-cuban-gold-bitcoin-167281-6180-1283-1672817540.jpg">
                            </div>
                        </div>
                    </a>
