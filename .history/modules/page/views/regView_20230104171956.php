                            ...
                            <div class="form-group">
                                ...
                                <div class="col-6 pl-0">
                                    <div class="input-group">
                                        <input type="number" min="0" max="50" class="form-control" name="number_loan" id="number_loan" placeholder="Chọn số" value="" />
                                        <div class="input-group-append">
                                            <span class="input-group-text text-danger">Triệu</span>
                                        </div>
                                    </div>
                                </div>
