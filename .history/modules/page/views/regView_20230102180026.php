                    ...
                    <div class="row">
                        <div id="info-customer" class="col-md-6">
                            ...
                            <div class="form-group d-flex align-items-center">
                                <input type="radio" name="check_address" id="yes" value="yes" <?php if (isset($check_address) && $check_address == 'yes') echo 'selected' ?>>
                                <label for="yes" class="ml-2 mr-5 font-weight-normal">Có</label>
                                <input type="radio" name="check_address" id="no" value="no" <?php if (isset($check_address) && $check_address == 'no') echo 'selected' ?>>
                            ...
                            <div class="form-group proof_documents">
                                <input type="text" class="form-control" name="proof_document" id="
