            ...
            -->
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title f-20">Đăng ký thành công <span><i class="fa-regular fa-circle-check f-20"></i></span></h5>
                        ...
                        <div class="modal-body">
                            ...
                            <p class="f-16">Hoặc bạn có thể liên hệ hotline: 086.830.0516</p>
                        </div>
                        <!-- END MODAL-BODY  -->
