                    ...
                    <div class="row">
                        <div id="info-customer" class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="fullname" id="fullname"
                                    placeholder="Nhập họ tên" value="<?php echo set_value('fullname') ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" name="number_phone" id="number_phone"
                                    placeholder="Nhập số điện thoại" value="<?php echo set_value('number_phone') ?>" />
                                <span class="error" id="error_number_phone"></span>
                            </div>
                            <div class="form-group">
                                <label for="address">Địa chỉ đang ở? <span class="star">*</span></label>
                                <input type="text" class="form-control" name="address" id="address"
                                    placeholder="Nhập địa chỉ bạn đang ở?" value="<?php echo set_value('address') ?>" />
                            ...
                            <div class="form-group d-flex align-items-center">
                                <input type="radio" name="check_address" id="yes" value="yes"
                                    <?php if (isset($check_address) && $check_address == 'yes') echo 'checked' ?>>
                                <label for="yes" class="ml-2 mr-5 font-weight-normal">Có</label>
                                <input type="radio" name="check_address" id="no" value="no"
                                    <?php if (isset($check_address) && $check_address == 'no') echo 'checked' ?>>
                            ...
                            <div class="form-group proof">
                                <input type="text" class="form-control" name="proof_document" id="proof_document"
                                    placeholder="Nhập giấy tờ chứng minh nhà của bạn (VD: Sổ đỏ, sổ hồng,...)"
                                    value="<?php echo set_value('proof_document') ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-8 col-lg-6 pl-0">
                                    <div class="input-group">
                                        <input type="number" min="0" max="50" class="form-control text-center"
                                            name="number_loan" id="number_loan" placeholder="Nhập số" value="" />
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group form-check d-flex align-items-center">
                                            <input type="checkbox" class="form-check-input" name="exhibit"
                                                value="CCCD Chip" id="cccd" />
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group form-check d-flex align-items-center">
                                            <input type="checkbox" class="form-check-input" name="exhibit"
                                                value="Giấy khai sinh con" id="gks_con" />
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group form-check d-flex align-items-center">
                                            <input type="checkbox" class="form-check-input" name="exhibit"
                                                value="Đăng ký xe máy" id="reg_moto" />
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group form-check d-flex align-items-center">
                                            <input type="checkbox" class="form-check-input" name="exhibit"
                                                value="Đăng ký xe ô tô" id="reg_car" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="exhibit"
                                                placeholder="Nhập giấy tờ khác bạn có thể để lại" value=""
                                                id="exhibit_dif" />
                        ...
                        <div class="col-md-12 text-center">
                            <div class="wp-btn-reg">
                                <button type="submit" name="btn_reg" class="btn_reg btn">ĐĂNG KÝ <span class="arrow"><i
...
<div class="container">
    <div id="advantages" class="container box">
        <div class="head-box">
            <div class="row">
                <div class="col-md-12">
                    <p class="title">Ưu điểm khi vay tại F86</p>
                </div>
            </div>
        </div>
...
<div class="container">
    <div id="should-choose" class="container box">
        <div class="head-box">
            <div class="row">
                <div class="col-md-12">
                    <p class="title">Bạn nên chọn F86</p>
                </div>
            </div>
        </div>
            ...
            <div class="row text-center">
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="thong-tin-dang-ky.html#wp-info-reg"><img
                                src="./public/images/should_choose/thu_tuc.png" alt=""></a>
                        <p>Chỉ cần bạn đang có mặt và làm việc tại Hà Nội</p>
                    </li>
                </div>
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="thong-tin-dang-ky.html#wp-info-reg"><img
                                src="./public/images/should_choose/tham_dinh.png" alt=""></a>
                        <p>
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="thong-tin-dang-ky.html#wp-info-reg"><img
                                src="./public/images/should_choose//lai_suat.png" alt=""></a>
                        <p>Lãi suất ưu đãi nhất Hà Nội</p>
                    </li>
                </div>
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="thong-tin-dang-ky.html#wp-info-reg"><img src="./public/images/should_choose/tu_van.png"
                                alt=""></a>
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="thong-tin-dang-ky.html#wp-info-reg"><img
                                src="./public/images/should_choose/bao_mat.png" alt=""></a>
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="thong-tin-dang-ky.html#wp-info-reg"><img
                                src="./public/images/should_choose/niemtin.png" alt=""></a>
    ...
    <div class="row">
            ...
            -->
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title f-20 color-green">Đăng ký thành công <span><i
                                        class="fa-regular fa-circle-check f-20 color-orange"></i></span></h5>
                        ...
                        <div class="modal-body">
                            ...
                            <p class="f-16">Hoặc bạn có thể liên hệ hotline: <a href="tel:0903261529"><span
                                        class="f-20 color-green">0903.261.529</span></a></p>
                        </div>
                        <!-- END MODAL-BODY  -->
        ...
        <div class="col-md-12">
            ...
            -->
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title f-20 color-green color-red">Đăng ký không thành công <span><i
                                        class="fa-regular fa-circle-xmark colored f-20"></i></h5>
                            <button class="close" data-dismiss="modal">
                        ...
                        <!-- END MODAL-HEADER -->
                        <div class="modal-body">
                            <p class="f-16">Bạn đã đăng ký <span class="font-weight-bold color-red">không</span> thành
                                công.</p>
                            <p class="f-16">Vui lòng điền đầy đủ thông tin đăng ký để được hỗ trợ nhanh nhất.</p>
                            <p class="f-16">Hoặc bạn có thể liên hệ hotline: <a href="tel:0868300516"><span
                                        class="f-20 color-red">086.830.0516</span></a></p>
                        </div>
                        <!-- END MODAL-BODY  -->
                        <div class="modal-footer">
