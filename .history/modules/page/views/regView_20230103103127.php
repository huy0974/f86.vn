                ...
                <form id="form" action="" method="post">
                    <div class="row">
                        <div id="info-customer" class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="test">Địa chỉ đang ở? <span class="star">*</span></label>
                                <input type="text" class="form-control" name="test" id="test" placeholder="Nhập địa chỉ bạn đang ở?" value="<?php echo set_value('test') ?>" />
