            ...
            -->
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Đăng ký thành công <span><i class="fa-regular fa-circle-check"></i></span></h5>
                        ...
                        <div class="modal-body">
                            ...
                            <p>Vui lòng chờ đợi tổng đài chăm sóc khách hàng liên hệ với bạn.</p>
                            <p>Hoặc bạn có thể liên hệ hotline: 086.830.0516</p>
                        </div>
                        <!-- END MODAL-BODY  -->
