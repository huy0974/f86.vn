                        ...
                        <div id="info-customer" class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="number_loan" id="number_loan" placeholder="Nhập số tiền cần vay" value="" />
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control" type="text" name="email" aria-label="Recipient's " id="email">
                                    <div class="input-group-append">
