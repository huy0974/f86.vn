                            ...
                            <div class="form-group">
                                ...
                                <div class="col-8 col-lg-6 pl-0">
                                    <div class="input-group">
                                        <input type="number" min="0" max="50" class="form-control text-center" name="number_loan" id="number_loan" placeholder="Nhập số" value="" />
            ...
            <div class="row text-center">
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="#wp-info-reg"><img src="./public/images/should_choose/thu_tuc.png" alt=""></a>
                        <p>Thủ tục đơn giản chỉ cần CCCD & sổ hộ khẩu Hà Nội</p>
                    </li>
                </div>
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="#wp-info-reg"><img src="./public/images/should_choose/tham_dinh.png" alt=""></a>
                        <p>
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="#wp-info-reg"><img src="./public/images/should_choose//lai_suat.png" alt=""></a>
                        <p>Lãi suất ưu đãi nhất Hà Nội</p>
                    </li>
                </div>
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="#wp-info-reg"><img src="./public/images/should_choose/tu_van.png" alt=""></a>
                        <p>Đăng ký tư vấn online dễ dàng</p>
                    </li>
                </div>
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="#wp-info-reg"><img src="./public/images/should_choose/bao_mat.png" alt=""></a>
                        <p>Bảo mật thông tin khách hàng</p>
                    </li>
                </div>
                <div class="col-6 col-md-4 col-xl-2">
                    <li class="reason-item">
                        <a href="#wp-info-reg"><img src="./public/images/should_choose/niemtin.png" alt=""></a>
