    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            -->
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title f-20 color-green color-red">Đăng ký <span class="font-weight-bold color-danger">không</span> thành công <span><i class="fa-regular fa-circle-xmark colored f-20"></i></h5>
                            <button class="close" data-dismiss="modal">
