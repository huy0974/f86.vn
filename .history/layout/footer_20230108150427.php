...
<div id="footer">
    ...
    <div id="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="footer-logo col-md-3 col-lg-2 col-3">
                    <a href="" class="logo">
                        <img src="./public/images/footer_logo.png" alt="">
                    </a>
                </div>
                <div class="footer-info-contact col-md-7 col-9 col-lg-4">
                ...
                <div class="footer-fanpage col-lg-6 col-12 col-md-12 mt-5 mt-lg-0 text-left text-lg-left">
