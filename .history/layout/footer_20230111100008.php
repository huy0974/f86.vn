    ...
    <div id="footer-bottom">
        <div id="social-icon-mobile" class="d-flex d-md-none">
            <div class="d-flex justify-content-center align-items-center">
                <a href="">
                    <img src="./public/images/footer/social/call_1.png" alt="">
                    <p>Gọi ngay</p>
                </a>
            </div>
            <div class="d-flex justify-content-center align-items-center">
                <a href="" target="_blank">
                    <img src="./public/images/footer/social/messmb_1.png" alt="">
                    <p>Facebook chat</p>
                </a>
            </div>
            <div class="d-flex justify-content-center align-items-center">
                <a href="" target="_blank">
                    <img src="./public/images/footer/social/zalomb_1.png" alt="">
                    <p>Zalo chat</p>
                </a>
            </div>
        </div>
