...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="./public/images/footer/logo/logo_footer_f86.png">
...
<body>
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0"
        nonce="bnH7Dd9t"></script>
    <!-- test  -->
    <div id="wrapper">
        <div id="wp-header" class="d-none d-lg-block">
            <div id="header" class="header-desktop">
                <div class="container">
                    <div class="logo">
                        <a href="trang-chu.html" class="logo">
                            <img src="./public/images/header/logo_f86.png" alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="header-bottom">
                    <div class="container d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-md-6">
                            <p class="w-content"><span class="content text-uppercase">Hỗ trợ tài chính cá nhân hà
                                    nội</span></p>
                        </div>
                        <div class="col-md-4 text-right pr-md-0">
                            <a href="tel:0903261529" class="hotline hotline-header text-decoration-none">
            ...
            <div id="header" class="header-mobile">
                ...
                <div class="header-bottom">
                    <div class="container d-flex justify-content-end">
                        <a href="tel:0903261529" class="hotline hotline-header text-decoration-none mt-0">
                            <span class="icon-phone"><i class="fa-solid fa-phone-volume animation-phone"></i></span>
                            <span>0903.261.529</span>
                        </a>
                    </div>
