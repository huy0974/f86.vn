...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="./public/images/footer_logo.png">
...
<body>
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0" nonce="bnH7Dd9t"></script>
    <!-- test  -->
    <div id="wrapper">
        <div id="wp-header">
            ...
            <div id="header" class="header-moblie d-block d-lg-none">
                <div class="container">
                    <!-- <div class="logo">
                        <a href="?mod=home" class="logo">
                            <img src="./public/images/LOGO.png" alt="">
                ...
                <div class="header-top">
                    <!-- <div class="container"> -->
                    <ul class="benefit d-flex no-gutters">
                        <li class="benefit-item col-4 pd-0">Lãi suất hấp dẫn</li>
                        <li class="benefit-item col-4 pd-0">Thủ tục đơn giản </li>
                        <li class="benefit-item col-4 pd-0">Giải ngân dễ dàng</li>
                    </ul>
                    <!-- </div> -->
                </div>
            </div>
