...
<div id="footer">
    ...
    <div id="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="footer-logo col-md-3 col-3">
                    <a href="" class="logo">
                        <img src="./public/images/footer_logo.png" alt="">
                    </a>
                </div>
                <div class="footer-info-contact col-md-5 col-9 col-lg-4">
                ...
                <div class="footer-fanpage col-lg-6 col-12 col-md-5 mt-3 mt-md-0 text-center">
